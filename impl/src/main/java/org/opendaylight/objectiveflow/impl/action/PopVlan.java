...
public class PopVlan extends AbstractAction {
    @Override
    Action createAction() {
        PopVlanAction action = new PopVlanActionBuilder().build();
        return new PopVlanActionCaseBuilder().setPopVlanAction(action).build();
    }
