...
public class Ipv4Source implements Match {
    CidrNotation cidrNotation;

    public Ipv4Source(CidrNotation cidrNotation) {
    ...
    public void setup(MatchBuilder matchBuilder) {
        ...
        builder.setIpv4Source(new Ipv4Prefix(cidrNotation.getIpv4Address()));
        matchBuilder.setLayer3Match(builder.build());
    }

    @Override
    public String toString() {
        final StringBuffer sb = new StringBuffer("Ipv4Source{");
