...
public class ArpTargetTransportAddress implements Match {
    CidrNotation cidrNotation;

    public ArpTargetTransportAddress(CidrNotation cidrNotation) {
    ...
    public void setup(MatchBuilder matchBuilder) {
        ...
        builder.setArpTargetTransportAddress(new Ipv4Prefix(cidrNotation.getIpv4Address()));
        matchBuilder.setLayer3Match(builder.build());
    }

    @Override
    public String toString() {
        final StringBuffer sb = new StringBuffer("ArpTargetTransportAddress{");
